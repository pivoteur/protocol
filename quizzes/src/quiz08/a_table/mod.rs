...
/// Scans a table, indexing into it: table is streamed from stdin
#[derive(Debug, Parser)]
struct Args {
   /// row indexed into
   row: usize,
...
pub fn runoff_with_args() -> ErrStr<()> {
   ...
   parse_and_print_call_datum(lines, args.row, &args.col)
}
...
mod test_data {
   ...
   pub fn calls() -> Vec<String> {
      lines("ix,pool,open_pivots,last_pivot_on_dt,opened,ids,close_id,close_date,from,from_blockchain,amount1,virtual,quote1,val1,gain_10_percent,pivot_token,pivot_blockchain,pivot_close_price,pivot_amount,proposed_token,proposed_blockchain,proposed_close_price,proposed_amount,roi,apr
...
6,BTC+UNDEAD,20,2026-04-09,2026-03-28,32;34;40,15,2026-04-27,UNDEAD,Avalanche,833400,540280.56,$0.000843,$1158.61,1511048.6,BTC,Avalanche,$77821.00,0.03893714,UNDEAD,Avalanche,$0.001461,2074605.4,51.03%,620.81%")
   }
}
